...
// A distribution in zPages format
...
// A single value in zPages format
...
export class StatszPageHandler {
  ...
  /**
   * Extracts distribution data needed to render the statsz page.
  ...
  /**
   * Extracts single value data needed to render the statsz page.
   * @param selectedView The current view
   */
