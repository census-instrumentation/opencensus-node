...
export namespace opencensus.proto {
  ...
  export namespace trace.v1 {
    ...
    export namespace Span {
      ...
      export enum SpanKind {SPAN_KIND_UNSPECIFIED = 0, SERVER = 1, CLIENT = 2}

      export interface Attributes {
        attributeMap?: {[k: string]: opencensus.proto.trace.v1.AttributeValue}|
            null;
      ...
      export interface TimeEvent {
        ...
        messageEvent?: opencensus.proto.trace.v1.Span.TimeEvent.MessageEvent|
            null;
      }
      ...
      export namespace TimeEvent {
        ...
        export interface MessageEvent {
          type?: opencensus.proto.trace.v1.Span.TimeEvent.MessageEvent.Type|
              null;
          id?: number|Long|null;
        ...
        export namespace MessageEvent {
          export enum Type {TYPE_UNSPECIFIED = 0, SENT = 1, RECEIVED = 2}
        }
      }
